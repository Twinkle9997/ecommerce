...
@section('body')
    ...
    <div class="hidden" id="fileRepeater">
        <div class="flex flex-col gap-3 justify-center items-center relative mt-3 fileRecord">
    ...
    <div class="grid grid-cols-1 mx-auto mt-5 px-[calc(10px+3vw)] mb-[100px]">
        <div class="shadow-lg p-[calc(5px+1vw)] bg-white flex flex-col gap-2">
            ...
            <form action="{{ route('form.upload') }}" method="POST" enctype="multipart/form-data">
                ...
                {{-- Courier Charges & Return Applicable --}}
                <div class="flex flex-wrap w-full gap-[10px] mt-3">
                    <div class="w-full sm:w-[calc(33%-5px)] min-w-[250px]">
                        <label for="category" class="text-sm sm:text-base">
                    ...
                    <div class="w-full sm:w-[calc(33%-5px)] min-w-[250px]">
                        <x-admin.label-text-with-alert type="date" label="Coupon Start Date" name="couponStart"
                            placeholder="Coupon Start Date" tooltip="Staring Date your coupon" peerName="peer/sd"
                            peerCondition="peer-focus/sd:block" />
                    </div>
                    <div class="w-full sm:w-[calc(33%-5px)] min-w-[250px]">
                        <x-admin.label-text-with-alert type="date" label="Ending Date" name="couponEnding"
                            placeholder="" tooltip="Coupon ending date" peerName="peer/ed"
                            peerCondition="peer-focus/ed:block" />
                    </div>
                </div>
