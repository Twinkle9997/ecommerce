...
@section('body')
    <div class="flex flex-col justify-center items-center px-3 my-5 md:my-[30px]">
        ...
        <div class="flex flex-col md:flex-row h-auto my-5 shadow-xl max-w-[350px] md:max-w-[calc(500px+10vw)] w-full">
            ...
            <div class="md:w-1/2 max-w-[350px] p-4 h-auto flex flex-col justify-center items-center  rounded-b md:rounded-r">
                ...
                <form action="{{ route('seller.signup') }}" method="post" class="flex flex-col gap-5 w-full"
                    autocomplete="off">
                    @csrf
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="mobile" name="mobile" class="focus:outline-none w-full rounded h-12 px-2 shadow"
                            minlength="10" maxlength="10" placeholder="your valid mobile number" />
                        @error('mobile')
                            <span class="text-xs text-textRed"> {{ $message }} </span>
                        @enderror
                    </div>
                    ...
                    <div class="flex justify-center">
                        <x-common.button-second type="submit" title="Sign Up" />
                    </div>
                </form>

                <div class="flex justify-end gap-2 mt-3">
                    <a href=""
                        class="flex justify-center items-center bg-bgRed text-white w-8 h-8 rounded-full hover:bg-bgMehandi duration-500 hover:shadow-lg"
        ...
        <div class="text-center flex items-center gap-2">
            ...
            <a href="{{ route('seller.login') }}" class="bg-bgRed p-0 px-2 text-white rounded shadow">
                Here!
            </a>
